...
function Send_Content( $var ) {
	...
	add_action(
		...
		<div style="text-align: left;;padding:15px;font-size:13px;font-family:inherit;">
			...
			<a href=<?php echo $var->form_link; ?> style="text-decoration: underline;"><?php echo $var->form_link; ?></a>
			...
			<div class="offline_course" style="text-align: left;">
				...
				<p>課程地點：<a href="https://www.google.com/maps/place/<?php echo $var->course_location; ?>" target="_blank"><?php echo $var->course_location; ?></a></p>
