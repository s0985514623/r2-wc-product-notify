...
const releasedPluginName = "r2-wc-product-notify";
...
module.exports = {
  ...
  hooks: {
    ...
    "after:bump": ["yarn build && echo ✅ build success && yarn sync:version && echo ✅ sync version success", "yarn create:release && echo ✅ create release files success", `cd release/${releasedPluginName}/${releasedPluginName} && composer install --no-dev && cd ../.. && echo ✅ composer install success`, "yarn zip && echo ✅ create zip success"], // run after bumping version
